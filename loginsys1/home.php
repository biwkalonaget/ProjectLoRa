      ...
      <ul>
        <li></li>
        	  ...
        	  <li><a href="./login.php">Login</a></li>
        	   ...
        	   <li><a href="#"onClick="javascript:window.open('./inc/add.php' , 'AddUser' ,'nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=600,height=500,top=150,left=650 ' )">Register</a></li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
