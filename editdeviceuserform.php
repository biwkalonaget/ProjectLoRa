	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="post" action="./incprocess/editdeviceuserprocess.php" class="login100-form validate-form">
					...
					<option style="display:none;"><?php echo $devicetypeName ?></option>
					...
					<div class="wrap-input100 validate-input" data-validate = "deviceName is required">
						<input class="input100" type="text" name="deviceName" value="<?php echo $deviceName ?>">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "deviceDes is required">
						<input class="input100" type="text" name="deviceDes" value="<?php echo $deviceDes ?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="container-login100-form-btn">
						<input type="submit" class="login100-form-btn" id="edit" name="edit" value="Edit" onclick="return confirm('Want to Create ?')">
